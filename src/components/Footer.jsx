  ...
  return (
    <footer id="mentions-legales">
      <div style={{ maxWidth:1320, margin:'0 auto 2.4rem', display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:'2rem 3rem', textAlign:'left' }}>
        ...
        <div>
          <p style={{ fontFamily:'IBM Plex Mono,monospace', fontSize:'.62rem', letterSpacing:'.1em', textTransform:'uppercase', color:'var(--c-cherry-soft)', marginBottom:'.8rem' }}>Programme d'affiliation</p>
          <p style={{ fontSize:'.78rem', color:'var(--ash)', lineHeight:1.75 }}>
            Ce site participe au Programme Partenaires d'Amazon EU, un programme d'affiliation conçu pour permettre à des sites de percevoir une rémunération grâce à la création de liens vers Amazon.fr. En tant que Partenaire Amazon, nous réalisons un bénéfice sur les achats remplissant les conditions requises, sans surcoût pour l'acheteur.
          </p>
        </div>
        <div>
          ...
          <p style={{ fontSize:'.78rem', color:'var(--ash)', lineHeight:1.75 }}>
            Les adresses email collectées sont utilisées uniquement pour vous informer de la disponibilité de l'iPhone 18 sur Amazon. Elles ne sont pas transmises à des tiers. Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et de suppression en nous contactant à{' '}
      ...
      <div style={{ borderTop:'1px solid rgba(243,239,231,.1)', paddingTop:'1.4rem', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'.8rem' }}>
        ...
        <p style={{ fontSize:'.72rem', color:'#6b6357' }}>
          © 2025 AJagency — Les spécifications affichées sont basées sur les informations disponibles avant lancement officiel et peuvent différer du produit final.
        </p>
      </div>
    </footer>
  )
